    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        <input
          ...
          value={value}
          onChange={onChange}
          className={`w-full rounded-lg px-4 py-3 text-sm text-gray-200 outline-none transition-all duration-200 placeholder-gray-500 bg-white/5 border focus:ring-2 ${error
...
export default function Register({ onSwitchToLogin, onGoHome, onLoginSuccess }) {
  ...
  const validateForm = () => {
    ...
    if (!form.mot_de_passe) {
      ...
      newErrors.mot_de_passe = "Le mot de passe doit avoir au moins 8 caractères.";
    }
